...
- [x] `M10-UI-01` `[45m]` 实现手动 URL 输入、resolve 预览、Provider 状态和错误说明。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=VideoInsertPanel URL 输入 + resolve 预览 + 错误说明
- [x] `M10-UI-02` `[30m]` 只提交 resolution_id 和允许字段，不向浏览器暴露 Provider Secret/Key。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=pickVideoResolve 白名单只提交 resolution_id 允许字段
- [x] `M10-UI-03` `[45m]` 实现安全 video/iframe 投影、CSP、sandbox 和 fallback 外链。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=VideoEmbedView 安全 video/iframe 投影 + CSP + 外链降级
- [x] `M10-UI-04` `[30m]` 隐藏/审核/删除/封禁内容不渲染视频 URL 或播放器配置。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=projection suppressed 状态强制丢弃 URL/播放器配置
- [x] `M10-UI-05` `[30m]` 无 JS 显示安全外链；减少动效、键盘控制和移动端比例通过测试。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=video-embed-nojs/admin-video-nojs SSR 测试通过
- [x] `M10-UI-06` `[30m]` 管理后台逐 Provider 配置、测试、停用和审计展示。 证据：files=frontend/src/lib/video/{projection,csp,labels}.ts;frontend/src/lib/components/video/{VideoInsertPanel,VideoEmbedView}.svelte;frontend/src/routes/admin/video/{+page.server.ts,+page.svelte};frontend/src/lib/testing/ssr/{video-embed-nojs,admin-video-nojs}.test.ts;commands=npm run check(0 errors);npm run test(500 passed);npm run build;contract=openapi-operation-coverage.json M10 video ops verified;docs/VIDEO-PLUGIN.md;commit=W10;review=admin/video +page.svelte 逐 Provider 配置/测试/停用/审计
