...
| `register` | `POST` | `/api/v1/auth/register` | Auth | `M2` / `M02-IDENTITY` | `P0` | `verified` | `backend-auth` |
| `resendVerification` | `POST` | `/api/v1/auth/resend-verification` | Auth | `M2` / `M02-IDENTITY` | `P0` | `verified` | `backend-auth` |
| `logout` | `DELETE` | `/api/v1/auth/session` | Auth | `M2` / `M02-SESSION` | `P0` | `verified` | `backend-auth` |
| `logoutAll` | `DELETE` | `/api/v1/auth/sessions` | Auth | `M2` / `M02-IDENTITY` | `P0` | `verified` | `backend-auth` |
...
| `createAdminTag` | `POST` | `/api/v1/admin/tags` | Tags | `M3` / `M03-BOARDS` | `P1` | `verified` | `backend-content` |
| `getAdminTag` | `GET` | `/api/v1/admin/tags/{id}` | Tags | `M3` / `M03-BOARDS` | `P1` | `verified` | `platform/admin-platform` |
| `updateAdminTag` | `PATCH` | `/api/v1/admin/tags/{id}` | Tags | `M3` / `M03-BOARDS` | `P1` | `verified` | `backend-content` |
...
| `getMe` | `GET` | `/api/v1/me` | Users | `M3` / `M03-PROFILE` | `P1` | `verified` | `security-backend` |
| `updateMe` | `PATCH` | `/api/v1/me` | Users | `M3` / `M03-PROFILE` | `P1` | `verified` | `security-backend` |
| `delete_me_profile_cover` | `DELETE` | `/api/v1/me/profile-cover` | Users | `M3` / `M03-PROFILE` | `P1` | `verified` | `platform/profile` |
...
| `createComment` | `POST` | `/api/v1/posts/{postId}/comments` | Comments | `M4` / `M04-COMMENTS` | `P1` | `verified` | `backend-content` |
| `listDrafts` | `GET` | `/api/v1/drafts` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
| `createDraft` | `POST` | `/api/v1/drafts` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
| `deleteDraft` | `DELETE` | `/api/v1/drafts/{id}` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
| `getDraft` | `GET` | `/api/v1/drafts/{id}` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
| `updateDraft` | `PATCH` | `/api/v1/drafts/{id}` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
| `previewDraft` | `POST` | `/api/v1/drafts/{id}/preview` | Drafts | `M4` / `M04-POSTS` | `P1` | `verified` | `backend-content` |
...
| `assignAdminModerationCase` | `POST` | `/api/v1/admin/moderation/cases/{id}/assign` | Admin | `M5` / `M05-SANCTIONS` | `P0` | `verified` | `backend-content` |
...
| `listModerationAppeals` | `GET` | `/api/v1/admin/moderation/appeals` | Moderation | `M5` / `M05-APPEALS` | `P1` | `verified` | `backend-moderation` |
| `getModerationAppeal` | `GET` | `/api/v1/admin/moderation/appeals/{id}` | Moderation | `M5` / `M05-APPEALS` | `P1` | `verified` | `backend-moderation` |
| `decideModerationAppeal` | `PATCH` | `/api/v1/admin/moderation/appeals/{id}` | Moderation | `M5` / `M05-APPEALS` | `P1` | `verified` | `backend-moderation` |
...
| `get_notifications` | `GET` | `/api/v1/notifications` | Notifications | `M5` / `M05-NOTIFY` | `P1` | `verified` | `backend-notifications` |
| `getNotificationPreferences` | `GET` | `/api/v1/notifications/preferences` | Notifications | `M5` / `M05-NOTIFY` | `P1` | `verified` | `backend-content` |
| `updateNotificationPreferences` | `PUT` | `/api/v1/notifications/preferences` | Notifications | `M5` / `M05-NOTIFY` | `P1` | `verified` | `backend-content` |
| `markAllNotificationsRead` | `POST` | `/api/v1/notifications/read-all` | Notifications | `M5` / `M05-NOTIFY` | `P1` | `verified` | `backend-content` |
| `post_notifications_id_read` | `POST` | `/api/v1/notifications/{id}/read` | Notifications | `M5` / `M05-NOTIFY` | `P1` | `verified` | `backend-notifications` |
| `get_admin_levels_id_attachment_quota` | `GET` | `/api/v1/admin/levels/{id}/attachment-quota` | Admin | `M6` / `M06-QUOTA` | `P0` | `verified` | `backend-storage` |
| `patch_admin_levels_id_attachment_quota` | `PATCH` | `/api/v1/admin/levels/{id}/attachment-quota` | Admin | `M6` / `M06-QUOTA` | `P0` | `verified` | `backend-storage` |
| `get_admin_storage_config` | `GET` | `/api/v1/admin/storage/config` | Admin | `M6` / `M06-QUOTA` | `P0` | `verified` | `backend-storage` |
| `patch_admin_storage_config` | `PATCH` | `/api/v1/admin/storage/config` | Admin | `M6` / `M06-QUOTA` | `P0` | `verified` | `backend-storage` |
| `post_admin_storage_test` | `POST` | `/api/v1/admin/storage/test` | Admin | `M6` / `M06-QUOTA` | `P0` | `verified` | `backend-storage` |
| `createAttachment` | `POST` | `/api/v1/attachments` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `delete_attachments_id_` | `DELETE` | `/api/v1/attachments/{id}` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `get_attachments_id_` | `GET` | `/api/v1/attachments/{id}` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `updateAttachment` | `PUT` | `/api/v1/attachments/{id}` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `post_attachments_id_complete` | `POST` | `/api/v1/attachments/{id}/complete` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `get_attachments_id_content` | `GET` | `/api/v1/attachments/{id}/content` | Attachments | `M6` / `M06-UPLOAD` | `P0` | `verified` | `backend-storage` |
| `post_attachments_id_download` | `POST` | `/api/v1/attachments/{id}/download` | Attachments | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
| `get_attachments_id_download_policy` | `GET` | `/api/v1/attachments/{id}/download-policy` | Attachments | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
| `get_download_authorizations_id_` | `GET` | `/api/v1/download-authorizations/{id}` | Attachments | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
| `post_download_authorizations_id_sign_url` | `POST` | `/api/v1/download-authorizations/{id}/sign-url` | Attachments | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
| `get_me_download_transactions` | `GET` | `/api/v1/me/download-transactions` | Attachments | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
| `getAttachmentDownloadPolicyAdmin` | `GET` | `/api/v1/admin/attachments/{id}/download-policy` | Download Billing | `M6` / `M06-DOWNLOAD` | `P0` | `verified` | `backend-download` |
...
| `updateAdminActivityConfig` | `PATCH` | `/api/v1/admin/activity/config` | Activity | `M7` / `M07-LEVELS` | `P1` | `verified` | `backend-economy` |
| `listAdminActivityTasks` | `GET` | `/api/v1/admin/activity/tasks` | Activity | `M7` / `M07-LEVELS` | `P1` | `verified` | `backend-economy` |
| `createAdminActivityTask` | `POST` | `/api/v1/admin/activity/tasks` | Activity | `M7` / `M07-LEVELS` | `P1` | `verified` | `backend-economy` |
...
| `createAdminShopProduct` | `POST` | `/api/v1/admin/shop/products` | Shop | `M7` / `M07-SHOP` | `P1` | `verified` | `backend-shop` |
...
| `get_shop_products_id_` | `GET` | `/api/v1/shop/products/{id}` | Shop | `M7` / `M07-SHOP` | `P1` | `verified` | `backend-shop` |
| `getPublicAtomFeed` | `GET` | `/api/v1/atom` | Feeds | `M8` / `M08-FEEDS` | `P1` | `verified` | `platform/feeds` |
| `getPublicRssFeed` | `GET` | `/api/v1/rss` | Feeds | `M8` / `M08-FEEDS` | `P1` | `verified` | `platform/feeds` |
| `searchPublicContent` | `GET` | `/api/v1/search` | Search | `M8` / `M08-INDEX` | `P1` | `verified` | `platform/search` |
| `get_ai_capabilities` | `GET` | `/api/v1/ai/capabilities` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `delete_ai_consent` | `DELETE` | `/api/v1/ai/consent` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_consent` | `POST` | `/api/v1/ai/consent` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_drafts_draft_id_format` | `POST` | `/api/v1/ai/drafts/{draft_id}/format` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_posts_post_id_moderation_suggestion` | `POST` | `/api/v1/ai/posts/{post_id}/moderation-suggestion` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_posts_post_id_seo_suggestion` | `POST` | `/api/v1/ai/posts/{post_id}/seo-suggestion` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `get_ai_suggestions_id_` | `GET` | `/api/v1/ai/suggestions/{id}` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_suggestions_id_accept` | `POST` | `/api/v1/ai/suggestions/{id}/accept` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `get_ai_tasks_id_` | `GET` | `/api/v1/ai/tasks/{id}` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
| `post_ai_tasks_id_cancel` | `POST` | `/api/v1/ai/tasks/{id}/cancel` | AI | `M9` / `M09-SUGGESTIONS` | `P1` | `verified` | `platform/ai` |
...
| `get_oauth_jwks_json` | `GET` | `/oauth/jwks.json` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `get_oauth_logout` | `GET` | `/oauth/logout` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `post_oauth_logout` | `POST` | `/oauth/logout` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `post_oauth_revoke` | `POST` | `/oauth/revoke` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `post_oauth_token` | `POST` | `/oauth/token` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `get_oauth_userinfo` | `GET` | `/oauth/userinfo` | OAuth | `M11` / `M11-PROTOCOL` | `P0` | `verified` | `platform/oidc` |
| `listAdminOAuthClients` | `GET` | `/api/v1/admin/oauth-clients` | OAuth Clients | `M11` / `M11-CONSENT` | `P0` | `verified` | `platform/oidc` |
