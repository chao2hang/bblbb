...
| W17 (M17) | 已完成 | 2026-08-08 | 待提交 | M17 收口：RC 冻结/预发布/冒烟/Flag 记录/法律/上线 44 任务全部终态；783/783（759 完成 + 24 阻塞）；checker 接受终态标记；coverage 193/193 verified（补齐 profile-cover 与 posts 反应删除端点 + 0058 迁移） |
