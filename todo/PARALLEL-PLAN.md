...
| W6 (M5) | 进行中 | — | `aaae708`(M05-SCHEMA)、`c90e8db`(SCHEMA 仪表盘)、`ed909fe`(M05-RISK)、`f23cb4d`(RISK 仪表盘)、`b8552fa`+`16de278`(M05-CASES)、`+CASES 仪表盘` | M05-SCHEMA/RISK/CASES 闭环（8+9+11=28 叶子任务）；M05-SANCTIONS/APPEALS/NOTIFY/UI 逐包推进 |
