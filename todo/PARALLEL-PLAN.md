...
| W6 (M5) | 进行中 | — | `aaae708`(M05-SCHEMA)、`c90e8db`(SCHEMA 仪表盘)、`ed909fe`(M05-RISK)、`f23cb4d`(RISK 仪表盘)、`b8552fa`+`16de278`(M05-CASES)、`2bde5db`(CASES 仪表盘)、`300ebfd`(M05-SANCTIONS) | M05-SCHEMA/RISK/CASES/SANCTIONS 闭环（8+9+11+9=37 叶子任务）；M05-APPEALS/NOTIFY/UI 逐包推进 |
