...
| W6 (M5) | 进行中 | — | `aaae708`(M05-SCHEMA)、`c90e8db`(SCHEMA 仪表盘)、`ed909fe`(M05-RISK)、`f23cb4d`(RISK 仪表盘)、`b8552fa`+`16de278`(M05-CASES)、`2bde5db`(CASES 仪表盘)、`300ebfd`(M05-SANCTIONS)、`656b095`(SANCTIONS 仪表盘)、`f242434`(M05-APPEALS) | M05-SCHEMA/RISK/CASES/SANCTIONS/APPEALS 闭环（8+9+11+9+7=44 叶子任务）；M05-NOTIFY/UI 逐包推进 |
