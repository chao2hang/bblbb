-- BBLBB third-party Marketplace schema (M12-SCHEMA, MySQL)
--
...
CREATE TABLE marketplace_clients (
    ...
    oauth_client_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    ...
    webhook_secret_hash VARCHAR(64) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
...
CREATE TABLE offers (
    id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    client_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    external_offer_id VARCHAR(128) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
...
CREATE TABLE offer_versions (
    id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    offer_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
...
CREATE TABLE checkout_intents (
    ...
    currency_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    merchant_order_id VARCHAR(128) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    ...
    idempotency_key VARCHAR(200) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    created_at BIGINT NOT NULL,
    PRIMARY KEY (id),
...
CREATE TABLE purchases (
    id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    intent_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    client_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    user_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    offer_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    offer_version INT NOT NULL,
    ...
    merchant_operation_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    fee_operation_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    merchant_order_id VARCHAR(128) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    created_at BIGINT NOT NULL,
    updated_at BIGINT NOT NULL,
    PRIMARY KEY (id),
...
CREATE TABLE refunds (
    id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    purchase_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    client_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    amount BIGINT NOT NULL,
    status VARCHAR(32) NOT NULL DEFAULT 'requested',
    reason_code VARCHAR(64) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    reason TEXT NULL,
    merchant_refund_id VARCHAR(128) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    reversal_operation_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    refunded_by CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
