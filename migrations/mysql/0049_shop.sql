...
CREATE TABLE shop_products (
    ...
    slug VARCHAR(64) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    title VARCHAR(120) NOT NULL,
    description_safe TEXT NULL,
    icon_token VARCHAR(64) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
...
CREATE TABLE user_presentations (
    user_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    nickname_decoration_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    nickname_color_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    avatar_frame_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    avatar_attachment_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    profile_effect_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    title_prefix_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    profile_badge_ids_json TEXT NULL,
    post_effect_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
    version INT NOT NULL DEFAULT 1,
    updated_at BIGINT NOT NULL,
    created_at BIGINT NOT NULL,
    PRIMARY KEY (user_id),
