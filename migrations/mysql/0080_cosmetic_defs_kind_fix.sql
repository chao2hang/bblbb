-- 修复 cosmetic_defs kind CHECK 与代码枚举不一致（M07-SHOP-STUDIO，MySQL）
--
...
-- 样式定义在启用 CHECK 的 MySQL ≥ 8.0.16 上被数据库拒绝。放宽为代码实际
-- 枚举（保留 'badge' 兼容历史种子）。

ALTER TABLE cosmetic_defs DROP CHECK cosmetic_defs_kind_ck;
