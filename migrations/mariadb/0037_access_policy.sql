-- BBLBB content access policies (M04-SCHEMA-06, MariaDB)
--
...
ALTER TABLE posts ADD COLUMN access_policy_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
