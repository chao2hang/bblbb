...
CREATE TABLE search_documents (
    ...
    doc_id VARCHAR(64) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
    entity_type VARCHAR(16) NOT NULL,
    title VARCHAR(240) NOT NULL,
    body MEDIUMTEXT NOT NULL,
    excerpt VARCHAR(200) NOT NULL,
    slug VARCHAR(120) NOT NULL,
    author_id CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci CHARACTER SET ascii COLLATE ascii_general_ci NULL,
