...
import type { ActivitySummary, Presentation, SanctionItem, TrustLevelProgress, User } from '$lib/api/types';
...
export const load: PageServerLoad = async ({ cookies, request }) => {
  ...
  const [activityResult, sanctionsResult, trustResult, presentationResult, coverResult] = await Promise.all([
