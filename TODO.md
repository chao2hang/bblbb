...
> 当前阶段：**M2 身份/Session/MFA/UX（进行中）**；下一任务：[`M02-IDENTITY-07`](todo/M00-M02-foundation.md#m2)。
...
| M2 | 注册、邮箱验证、Session/CSRF、MFA | 4 | 44 | 34 / 10 / 0 | 进行中 | [`M00-M02`](todo/M00-M02-foundation.md#m2) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **91 完成 / 1 进行中 / 0 阻塞 / 691 未开始** |  |
