...
> 当前阶段：**全部 783 个叶子任务已达终态（759 完成 + 24 阻塞）**；下一任务：[`全部完成`](todo/M13-M17-release.md#m17)。
...
| M10 | Direct/HLS/Xigua 视频 | 2 | 18 | 12 / 6 / 0 | 完成 | [`M08-M12`](todo/M08-M12-integrations.md#m10) |
| M11 | OIDC Provider | 3 | 27 | 27 / 0 / 0 | 阻塞 | [`M08-M12`](todo/M08-M12-integrations.md#m11) |
| M12 | 第三方 Marketplace 原子账务 | 5 | 43 | 36 / 7 / 0 | 完成 | [`M08-M12`](todo/M08-M12-integrations.md#m12) |
| M13 | 主题、插件、管理后台 | 4 | 34 | 18 / 16 / 0 | 完成 | [`M13-M17`](todo/M13-M17-release.md#m13) |
...
| M17 | 冻结、预发布、专项 Gate、上线 | 6 | 44 | 39 / 0 / 5 | 阻塞 | [`M13-M17`](todo/M13-M17-release.md#m17) |
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **759 完成 / 0 进行中 / 24 阻塞 / 0 未开始** |  |
