...
> 当前阶段：**M1 数据库/配置/Job/审计（进行中）**；下一任务：[`M01-CONFIG-04`](todo/M00-M02-foundation.md#m1)。
...
| M1 | 三数据库、配置、Job/Outbox、审计 | 4 | 43 | 43 / 0 / 0 | 进行中 | [`M00-M02`](todo/M00-M02-foundation.md#m1) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **57 完成 / 1 进行中 / 0 阻塞 / 725 未开始** |  |
