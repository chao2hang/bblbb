...
> 当前阶段：**M4 内容与可见性完成，M5 风险审核/通知（进行中）**；下一任务：[`M05-SANCTIONS-01`](todo/M03-M05-community.md#m5)。
...
| M5 | 风险审核、举报、处罚、申诉、通知 | 7 | 63 | 37 / 26 / 0 | 进行中 | [`M03-M05`](todo/M03-M05-community.md#m5) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **274 完成 / 0 进行中 / 0 阻塞 / 509 未开始** |  |
