...
2. **`todo/` 是唯一执行清单**：共 102 个工作包、819 个唯一叶子任务（M0-M17 789 + M18 原型对齐 30）；每项带 15-60 分钟估时，工作包带优先级、owner、风险、依赖、目标文件和验收方式。
...
| **总计** |  | **102** | **819** | **544 / 266 / 9** | **788 完成 / 0 进行中 / 24 阻塞 / 7 未开始** |  |
