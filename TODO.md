...
> 当前阶段：**M2/M3 完成，M4 内容与可见性（进行中）**；下一任务：[`M04-MARKDOWN-01`](todo/M03-M05-community.md#m4)。
...
| M4 | Markdown、内容、回复、可见性 | 6 | 61 | 33 / 28 / 0 | 进行中 | [`M03-M05`](todo/M03-M05-community.md#m4) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **194 完成 / 0 进行中 / 0 阻塞 / 589 未开始** |  |
