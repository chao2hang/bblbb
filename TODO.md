...
> 当前阶段：**M12 全部实现完成（580/783），3 项外部专项（OIDC conformance / 独立 RP 集成 / 密钥恢复演练）阻塞中**；下一任务：[`M13-THEME-01`](todo/M13-M17-release.md#m13)。
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **580 完成 / 0 进行中 / 3 阻塞 / 200 未开始** |  |
