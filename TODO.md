...
> 当前阶段：**M0 工程治理**；下一任务：[`M00-TOOL-01`](todo/M00-M02-foundation.md#m00-tool)。
...
|---|---|---:|---:|---:|---|---|
| M0 | 工具链、契约、后端/前端边界 | 4 | 42 | 33 / 9 / 0 | 未开始 | [`M00-M02`](todo/M00-M02-foundation.md#m0) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **0 完成 / 0 进行中 / 0 阻塞 / 783 未开始** |  |
