...
> 当前阶段：**M2/M3 完成（身份/MFA/RBAC/板块/标签/搜索），进入 M4 Markdown/内容/回复/可见性**；下一任务：[`M04-SCHEMA-01`](todo/M03-M05-community.md#m4)。
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **185 完成 / 0 进行中 / 0 阻塞 / 598 未开始** |  |
