...
> 当前阶段：**M0 工程治理（收尾）**；下一任务：[`M00-FRONTEND-07`](todo/M00-M02-foundation.md#m0)。
...
|---|---|---:|---:|---:|---|---|
| M0 | 工具链、契约、后端/前端边界 | 4 | 42 | 33 / 9 / 0 | 进行中 | [`M00-M02`](todo/M00-M02-foundation.md#m0) |
| M1 | 三数据库、配置、Job/Outbox、审计 | 4 | 43 | 43 / 0 / 0 | 未开始 | [`M00-M02`](todo/M00-M02-foundation.md#m1) |
| M2 | 注册、邮箱验证、Session/CSRF、MFA | 4 | 44 | 34 / 10 / 0 | 未开始 | [`M00-M02`](todo/M00-M02-foundation.md#m2) |
| M3 | 资料、RBAC、板块、标签、搜索仓储 | 6 | 56 | 28 / 28 / 0 | 未开始 | [`M03-M05`](todo/M03-M05-community.md#m3) |
...
| **总计** |  | **87** | **783** | **544 / 234 / 5** | **39 完成 / 0 进行中 / 0 阻塞 / 744 未开始** |  |
