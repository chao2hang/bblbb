...
begin
  ...
  errors << "Expected frozen OpenAPI baseline of 183 operations, got #{contract_operations.length}" unless contract_operations.length == 183
...
if errors.empty?
  ...
  puts "OpenAPI coverage: 183/183 operations assigned"
else
