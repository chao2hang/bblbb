...
begin
  ...
  errors << "Expected frozen OpenAPI baseline of 184 operations, got #{contract_operations.length}" unless contract_operations.length == 184
...
if errors.empty?
  ...
  puts "OpenAPI coverage: 184/184 operations assigned"
else
