...
begin
  ...
  errors << "Expected frozen OpenAPI baseline of 176 operations, got #{contract_operations.length}" unless contract_operations.length == 176
...
if errors.empty?
  ...
  puts "OpenAPI coverage: 176/176 operations assigned"
else
